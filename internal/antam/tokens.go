...
// Map statis dari script JS Antam
var secretMap = map[string]string{
	...
	"13": "a3e63b82063ef2e3f6715d700c1de4c191abc8d97ca2da0e342e7adf6bb259e5", // Surabaya 1
	"14": "1a105b5a724b99400a715b6b8d043bf9f3b821c1caca1a599d3e7e1b1576b55a", // Surabaya 2
	"9":  "b47560b59c11452b1eaf31ecc2a32a0e2751e38b430c25a5c8eaf3a92b8bfe84", // Yogyakarta
}

// GetTokenBySiteID mengambil token string berdasarkan ID cabang
func GetTokenBySiteID(siteID string) (string, error) {
	if token, ok := secretMap[siteID]; ok {
		return token, nil
	}
	return "", errors.New("ID Cabang tidak ditemukan dalam database token")
}